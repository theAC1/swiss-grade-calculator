  ...
  return (
    <div className="bg-white rounded-xl shadow-sm border border-slate-200 flex flex-col h-full">
      ...
      <div className="p-4 border-b border-slate-100 flex justify-between items-center no-print">
        <h2 className="font-semibold text-lg text-slate-800">{t.students} ({students.length})</h2>
      ...
      {/* Table Header */}
      <div className="grid grid-cols-12 gap-2 px-4 py-3 bg-slate-50 border-b border-slate-200 text-xs font-semibold text-slate-500 uppercase">
        ...
        {students.length === 0 ? (
          ...
          <div className="divide-y divide-slate-100">
            {students.map((student) => (
              <div key={student.id} className="grid grid-cols-12 gap-2 px-4 py-2 items-center hover:bg-slate-50 transition-colors group">
                {/* Name Input */}
                <div className="col-span-5 md:col-span-6">
                  <input
                    ...
                    className="w-full bg-transparent border-none focus:ring-0 p-1 text-slate-800 text-sm font-medium placeholder-slate-400 outline-none"
                    placeholder={t.name}
                  />
                </div>
                ...
                <div className="col-span-3 md:col-span-2 flex justify-end">
                   <input
                    ...
                    className={`w-20 text-right bg-slate-50 border border-transparent hover:border-slate-300 focus:bg-white focus:border-indigo-400 rounded px-2 py-1 text-sm outline-none transition-all text-slate-800 ${
